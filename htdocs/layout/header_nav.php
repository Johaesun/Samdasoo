<div class="bag">
    <div class="etcFix">
        <img src="../img/close.png" class="etcFix_close" alt="닫기">
        <div class="etc_text">
            <h2>개인정보 보호정책</h2>
            <h3>개인정보 수집이용에 대한 동의</h3>
            <p>회원님의 소중한 개인정보는 다음과 같은 정책에 따라 수집 및 이용됩니다. 저희 오픈필드에서는 해당 목적에 연관되는 개인정보만을 수집하며, 수집된 정보를 투명하고 안전하게 보호 관리할 것을 약속합니다. 이에 개인정보 수집및 이용에 대한 동의를 구합니다.</p>
...
<div class="nav_wrap">
    ...
    <div class="nav">
        <img class="close" src="./img/close.png" alt="닫기">
        <ul class="mainMenu">
            <li>
