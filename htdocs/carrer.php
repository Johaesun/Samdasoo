...
<body>
	<div id="wrap">
			...
			<div class="box01_wrap">
				...
				<ul class="box01_text">
					<li>
						...
						<p>제주도 방언스럽기도 하고, 귀여운 맛이</p>
						<p>이번 광고 콘셉트와도 잘 어울렸습니다.</p>
					</li>
					<li>
						<p>제주삼다수를 좀 더 가깝게 만드는 작업을 영상 콘티 구성에</p>
						<p>적극 반영했습니다. 이를 통해 제주도의 매력을</p>
						<p>제주삼다수로 자연스럽게 링크시키면서 새롭게</p>
		...
		<div class="box03 container_carrer">
			<ul class="career">
				<li>
					<img src="./img/nbci.jpg" alt="한국생산성본부">
					<p>2015 국가브랜드 경쟁력지수(NBCI) 9년 연속 1위 (생수부문,한국생산성본부)</p>
				</li>
				<li>
					<img src="./img/BrandStar.jpg" alt="브랜드스타">
					<p>2015 대한민국 브랜드스타 10년 연속 선정 (생수부문1위,브랜드스타)</p>
				</li>
				<li>
					<img src="./img/K-BPI.jpg" alt="한국농물협회컨설팅">
					<p>2015 한국산업의 브랜드파워(K-BPI) 1위 (생수부문, 한국농물협회컨설팅)</p>
				</li>
				<li>
					<img src="./img/kb-pbi.jpg" alt="한국표준협회">
					<p>2015 프리미엄브랜드지수(KS-PBI) 1위 (생수부문, 한국표준협회)</p>
				</li>
				<li>
