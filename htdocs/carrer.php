...
<body>
    ...
    <?php
    	...
    	<div class="box01">
            ...
            <ul>
                <li>
                    <p>의도를 하나의 단어로 만들어 공유해보면 어떨까라는 생각이 들었어요.</p>
                    <p>여러 아이디어 가운데 ‘고맙습니다+삼다수’가 제주도 방언스럽기도 하고,</p>
                    <p>귀여운 맛이 이번 광고 콘셉트와도 잘 어울렸습니다.</p>
                    </li>
                <li>
                    <p>제주삼다수를 좀 더 가깝게 만드는 작업을 영상 콘티 구성에 적극 반영했습니다.</p>
                    <p> 이를 통해 제주도의 매력을 제주삼다수로 자연스럽게 링크시키면서</p>
                    <p>새롭게 관심이 가도록 ‘브랜드 리프레시먼트’를 캠페인 목표로 잡았습니다.</p>
                </li>
            </ul>
