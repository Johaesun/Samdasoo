    ...
    <?php
    	...
    	<div class="centent">
    	    <div class="text_box">
    	        ...
    	        <p>
    	            물허벅시대 1960년 이전부터 제주 지하수의 브랜드 시대 2000년대까지 무분별한 지하수 개발에 우리나라 최초의지하수 이용허가제 도입, 지하수 공수로 관리, 지하수 기초조사의 지속적 추진으로 제주도는 세계의 지하수 관리 모델로 떠올랐고, 그렇게 탄생한 제주 삼다수는 세계적으로 우수성을 인증받는 고품질 지하수로 인정받았습니다.
    	        </p>
    	    </div>
